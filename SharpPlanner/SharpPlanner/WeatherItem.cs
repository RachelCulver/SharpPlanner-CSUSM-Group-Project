...
//    using QuickType;
//
//    var wordItem = WordItem.FromJson(jsonString);
...
namespace SharpPlanner
{
    ...
    public partial class WeatherItem
    {
        public static WeatherItem FromJson(string json) => JsonConvert.DeserializeObject<WeatherItem>(json, SharpPlanner.Converter.Settings);
    }
